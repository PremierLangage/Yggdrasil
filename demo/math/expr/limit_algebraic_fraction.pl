...
<button class="btn btn-sm btn-outline-primary" style="margin-left: 2em" type="button" id="dropdownMenuButton" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
