...
[["Exécution simple", "13 13 13 13", ""],
 ...
 ["Test aléatoire 1", " ".join([str(random.randint(0,255)) for i in range(4)]), ""],
 ["Test aléatoire 2", " ".join([str(random.randint(0,255)) for i in range(4)]), ""],
 ["Test aléatoire 3", " ".join([str(random.randint(0,12)) for i in range(4)]), ""],
 ["Test aléatoire 4", " ".join([str(random.randint(0,255)) for i in range(4)]), ""],
 ["Test aléatoire 5", " ".join([str(random.randint(0,255)) for i in range(4)]), ""],
 ["Test aléatoire 6", " ".join([str(random.randint(0,255)) for i in range(4)]), ""],
 ["Test aléatoire 7", " ".join([str(random.randint(0,255)) for i in range(4)]), ""],
 ["Test aléatoire 8", " ".join([str(random.randint(0,255)) for i in range(4)]), ""],]
==
