...
[["Exécution simple", ["int"], "12 9 4 19 1 7 32 21"],
 ...
 ["Test aléatoire mots 1", ["char*"], " ".join([''.join([chr(randint(97,122)) for j in range(randint(1,20))]) for i in range(5, 15)])],
 ["Test aléatoire mots 2", ["char*"], " ".join([''.join([chr(randint(97,122)) for j in range(randint(1,20))]) for i in range(5, 15)])],
 ["Test aléatoire mots 3", ["char*"], " ".join([''.join([chr(randint(97,122)) for j in range(randint(1,20))]) for i in range(5, 15)])]]
==
