...
match.nodes.append({"id": "s2", "content": "Les différents états (liste finie) d'une tache de développement <br>(new, assigned, work in progress, need review, merged, closed) ", "source": True})
