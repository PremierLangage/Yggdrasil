...
if __name__ == "__main__":
    ...
    d['text'] = "Voici quelques instructions simples en langage C manipulant des variables entières. <br /><br />" + double_with_tab("\t"+code) + "\n\n <br /> Donnez la valeur de la variable **a** en fin d'exécution de ce bout de code ou bien entrez **Erreur** en cas d'instruction déclenchant une erreur durant l'exécution (typiquement une division par zéro).\n"
    d['responses'] = values
