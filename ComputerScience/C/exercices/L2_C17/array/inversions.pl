...
[
  ...
  { "content": """Une solution élémentaire est d'imbriquer les boucles `for(i=0 ; i<size ; i++)` et `for(j=i+1 ; j<size ; j++)` et de mettre à jour une variable accumulant `1` à chaque fois que `t[j] < t[i]`. On retourne l'accumulateur en fin de double boucle."""}
]
==
