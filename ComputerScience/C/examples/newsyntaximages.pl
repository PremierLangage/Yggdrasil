...
# la balise napo contient l'url absolue/externe du fichier 
# pour le moment 
# https://pl.u-pem.fr/filebrowser/options?name=download_resource&path=Yggdrasil/conceptexo/ComputerScience/C/examples/napoleon.jpg
napo $= napoleon.jpg
...
<img src="https://pl.u-pem.fr/filebrowser/options?name=download_resource&path=Yggdrasil/conceptexo/ComputerScience/C/examples/napoleon.jpg" />

![Couronement de Napoléon]({{ napo }})
==
