...
simg1 = '<table><tr><td><img src="'+str(url_phot_1)+'" alt="le style1" style="width : 150px;" /></td><td>La moustache suspendue assymétrique</td></tr></table>'
...
simg5 = '<table><tr><td><img src="'+str(url_phot_5)+'" alt="le style5" class="miniface" /></td><td>La stache du ranger Canado-américain</td></tr></table>'
