...
if nb_quest >= 8:
    ...
    text += '''<div class="item">'''
    text += '<p style="margin-left:15%; margin-right:15%;"><b><u>Critère 8 : </u></b></p><br>'
...
if nb_quest >= 9:
    ...
    text += '''<div class="item">'''
    text += '<p style="margin-left:15%; margin-right:15%;"><b><u>Critère 9 : </u></b></p><br>'
...
if nb_quest >= 10:
    ...
    text += '''<div class="item">'''
    text += '<p style="margin-left:15%; margin-right:15%;"><b><u>Critère 10 : </u></b></p><br>'
