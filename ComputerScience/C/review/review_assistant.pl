...
forms=['<table style="border-spacing: 30px; border-collapse: separate;">'
       ...
       '</table>',
       '<table>'
       '<tr><td><input type="radio" id="form_fail1" name="crit1" value="fail1"> &nbsp;</td> '
       '<td><label for="fail1"> L\'auteur a laissé des éléments inutiles ou des fichiers '
       'mal identifiés dans ses contenus.</label></td></tr>'
       '<tr><td><input type="radio" id="form_ok1" name="crit1" value="ok1"> &nbsp;</td> '
       '<td><label for="ok1"> Les productions et leurs éléments sont corrects et bien '
       'identifiés.</label></td></tr>'
       '<tr><td><input type="radio" id="form_ok+1" name="crit1" value="ok+1"> &nbsp;</td> '
       '<td><label for="ok+1"> Les productions transmises sont particulièrement bien structurées et '
       'la précision du nommage ne laisse aucun doute sur le contenu des '
       'répertoires et fichiers.</label></td></tr>'
       '<tr><td><input type="radio" id="form_ok++1" name="crit1" value="ok++1"> &nbsp;</td> '
