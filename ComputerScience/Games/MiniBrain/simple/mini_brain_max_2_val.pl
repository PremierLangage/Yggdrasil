...
title=Maximum de deux valeurs avec Mini Brain
...
text==
<p>
Proposez un code Mini-Brain qui compare les deux valeurs situées en case 
mémoire {{ a }} et {{ b }}. Une fois comparées, placez la plus grande des
deux valeurs à l'adresse {{ c }}.
</p>
==
