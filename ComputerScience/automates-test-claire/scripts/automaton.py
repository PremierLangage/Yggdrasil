...
class Automaton:
    ...
    def states(self):
        """
        Return a set of the final states of the automaton. e.g. ['S0', 'S1', 'S2', 'S3', 'S4']
        """
    ...
    @staticmethod
    #génère un automate avec numStates états sur l'alphabet de taille numAlphabet avec maxNumToStates transitions?? dfa indique si on veut un automate det
