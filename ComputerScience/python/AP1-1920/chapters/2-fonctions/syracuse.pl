...
Pour tout entier strictement positif $%u_0%$ que l'homme a testé,
...
* écrire une fontion `syracuse_temps(u)` qui reçoit un entier strictement positifs<br> 
  et renvoie le temps de vol de la suite de Syracuse pour $%u_0=u%$<br>
...
<br>
<br>
**Exemples d'exécution du programme :**<br>
