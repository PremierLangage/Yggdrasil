...
<input type="radio" id="form_radio" name="f_evaluation" value="copie_blanche">
<label for="copie_blanche">Copie blanche</label><br>
<input type="radio" id="form_radio" name="f_evaluation" value="insuffisant">
<label for="insuffisant">Insuffisant</label><br>
<input type="radio" id="form_radio" name="f_evaluation" value="passable">
<label for="passable">Passable</label><br>
<input type="radio" id="form_radio" name="f_evaluation" value="bien">
<label for="bien">Bien</label><br>
<input type="radio" id="form_radio" name="f_evaluation" value="tres_bien">
...
evaluator==#|python|
feedback = "J'ai bien lu votre formulaire " + response['radio'] + " " + response['pouet2']
note = 100
grade = (note, feedback)
==
