...
<input type="radio" id="form_copie_blanche" name="evaluation" value="copie_blanche">
<label for="copie_blanche">Copie blanche</label><br>
<input type="radio" id="form_insuffisant" name="evaluation" value="insuffisant">
<label for="insuffisant">Insuffisant</label><br>
<input type="radio" id="form_passable" name="evaluation" value="passable">
<label for="passable">Passable</label><br>
<input type="radio" id="form_bien" name="evaluation" value="bien">
<label for="bien">Bien</label><br>
<input type="radio" id="form_tres_bien" name="evaluation" value="tres_bien">
