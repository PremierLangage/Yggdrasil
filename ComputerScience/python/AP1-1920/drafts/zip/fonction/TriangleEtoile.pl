...
et renvoie une chaine formée de 1 caractère étoile ('*'), 2 caractère étoile ('*'),...,n caractère étoile ('*') e recoit séparés par des caratères plus ('+').
    si elle reçoit 4 elle renvoie "*+**+***+****".
