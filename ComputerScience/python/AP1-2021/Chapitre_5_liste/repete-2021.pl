...
Ecrire une fonction `repete` à deux paramètres (un entier `n` et une liste `ll`)  qui retourne une nouvelle liste composée de n copies de `l`, jointes de façon consécutive.
