...
text==
Ecrire une fonction ``tail(filename)`` qui prend en paramètre le nom d'un fichier et qui imprime **les dernières 5 lignes du fichier**. Si le fichier contient moins que 5 lignes, alors imprimer tous les lignes. On peut faire ça en lisant le fichier une et une seule fois.
==
