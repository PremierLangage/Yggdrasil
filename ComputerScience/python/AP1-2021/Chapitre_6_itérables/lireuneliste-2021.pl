...
text==
Cet exercice consiste à lire une liste depuis du clavier. Nous allons supposer que notre utilisateur va entrez une seule ligne de texte avec un espace entre chaque valeur de la liste par exemple :
