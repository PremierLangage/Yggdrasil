...
def randomfunc():
    ...
    if aff :
        ...
        text += " retourne "
    text += functeur[1]+" "+transform[1]+"des entiers "+filtre[1]+ "\n\t de la liste.\n"
    ...
    text += "\n\tSi la liste ne contient aucun entiers "+filtre[1]+"\n\t la fonction affiche rien et retourne None."
    ...
    try:
        with stdoutIO() as s:
            ...
            pltest += ">>> f("+str([x for x in range(-10,0)])+")\n"
