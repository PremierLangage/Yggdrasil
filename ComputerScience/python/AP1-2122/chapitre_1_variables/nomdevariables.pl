...
extends = /ComputerScience/AnthonyLabarre/BUT1-progalgo/exercices/noms_variables.pl


text==

Cocher les noms de variables corrects. 

Rappel:  
Un identifiant de variable commence par une lettre ou un souligné.  
