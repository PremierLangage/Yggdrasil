...
Mais comme nous pouvons recevoir beaucoup de fois le message nous proposons de chercher pour chaque position quelle est la lettre la plus fréquente.

Et de retourner le mot construit avec ces lettres.
