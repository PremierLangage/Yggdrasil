...
Ecrire une fonction `Cellulu * extraitsuivant(int precede)l `, qui extrait, si elle existe la cellule situé après celle contenant x.La fonction renvoie l'adresse de la cellule extraite ou NULL.
