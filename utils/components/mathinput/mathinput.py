...
class MathInput:
    ...
    def display_feedback(self):
        ...
        if score == 100:
            ...
            self.suffix = rf'<i class="fas fa-times" style="margin-left: 0.5em; color: #E53935; cursor: pointer;" data-bs-toggle="popover" data-bs-placement="bottom" data-bs-content="{msg}"></i>'
