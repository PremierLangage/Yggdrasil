...
class MathInput:
    ...
    def display_feedback(self):
        ...
        if score == 100:
            ...
            self.suffix = rf'<i class="fas fa-times" style="margin-left: 0.5em; color: #E53935; cursor: pointer;" data-toggle="popover" data-placement="bottom" data-trigger="focus" data-content="{msg}"></i>'
