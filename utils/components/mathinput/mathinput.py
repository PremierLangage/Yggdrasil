...
class MathInput:
    ...
    def display_feedback(self):
        ...
        if score == 100:
            ...
            self.suffix = rf'<i class="fas fa-exclamation-circle" style="margin-left: 0.5em; color: #FFB300; cursor: pointer;" data-toggle="popover" data-trigger="focus" data-placement="bottom" data-content="{msg}"></i>'
        else:
