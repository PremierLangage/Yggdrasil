...
# contenu des labels
integrale = "$$\int_0^1 x^2\, dx$$" # bug d'affichage: \, affiche une virgule
fraction =  "$$\frac12 - \frac13$$"
limite = "$$\lim_{x\to +\infty} x\sin(1/x)$$"
determinant = "$$\det\begin{pmatrix} 1 & 2\\ 1 & 3\end{pmatrix}$$" # bug d'affichage: la matrice s'affiche sur une ligne
