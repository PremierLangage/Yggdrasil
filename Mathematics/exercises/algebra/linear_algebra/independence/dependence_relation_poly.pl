...
Ces vecteurs sont liés. Déterminer une combinaison linéaire (à coefficients non tous nuls) de ces vecteurs qui est égale au vecteur nul.

*Note : la réponse attendue est du type $! 2u -v +3w !$.*
==
