...
<div id="jxgbox2" class="jxgbox" style="width:500px; height:100px;"></div>
<script type="text/javascript">
var board2 = JXG.JSXGraph.initBoard('jxgbox2', {showNavigation:false, boundingbox:[-1,4,5,-4], grid:false});
var ax = board2.create('line', [[0,0],[1,0]], {fixed:true});
board2.create('ticks',[ax, 1], {label: {anchorX: 'middle', anchorY: 'top', fontSize: 12, offset: [0, 10]}, anchor : 0., drawZero: true, drawLabels:true, minorTicks:2, majorHeight:20, minorHeight:10});
