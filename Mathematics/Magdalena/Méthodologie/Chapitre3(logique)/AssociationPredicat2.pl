...
$%\exists a \in E \quad \forall b \in E \quad  P(a,b)%$§ Un étudiant au moins a regardé le mur de tous les étudiants.
...
$%\exists a \in E \quad \forall b \in E\quad %$ non $%P(a,b)%$§ Un étudiant au moins n'a regardé aucun mur.
==
