...
+ $% \\{(p,n) \in \mathbb{Q}\times \mathbb{Z} \\;  | \\;  p \le  \pi  \quad  \exists k \in \mathbb{Z} \\; \mbox{ et } n= 5k+2  \\}%$ 
...
+ $%  \\{(p,n)  \\;  | \\;  p \in \mathbb{Q} \quad p \le  \pi  \quad n \in \mathbb{Z} \quad  \exists k \in \mathbb{Z} \\; \mbox{ et } n= 5k+2  \\}%$ 
