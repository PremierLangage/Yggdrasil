...
suivant un exercice de Premier Langage vous-même ! Vous serez donc, 
...
if __name__ == "__main__":
    ...
    if context['step'] == 6:
        context['text_exo'] += "<br \>form=Votre prénom : &lt;input type=\"text\" id=\"form_"+answers['id_prenom_exo']+"\"&gt;"
    ...
    if context['step'] == 7:
        ...
        context['text'] += "<br /><font color=\"DarkGreen\"><b>Ici, pour faire un exercice relativement minimal et autonome, je vais coder pour vous un grader très simple : il donne la meilleure note à tout le monde. Toutefois, c'est vous qui devrez fabriquer le feedback personnalisé.</b></font>"
    ...
    if context['step'] == 8:
        ...
        context['text_exo'] += "" 
        context['text'] += "<br/><br />"+make_file_exo(context['text_exo'])
        context['text'] += "<br /><font color=\"DarkGreen\"><b>On demande un prénom dans un formulaire web, essayez de proposer une phrase de feedback qui utilise ce prénom récupéré...</b></font>"
        context['text'] += "<br /><font color=\"DarkGreen\"><b>Ce schéma est la base de Premier Langage. Un exercice standard a un énoncé, puis propose un formulaire de réponses, ensuite les réponses sont évaluées dans un grader, et finalement, le grader a construit un feedback qui est proposé à l'élève.</b></font>"

        context['form'] = "<textarea id=\"form_text_exo\" rows=\"5\" cols=\"50\">\nMerci d'avoir réalisé cet exercice... \n</textarea>"
