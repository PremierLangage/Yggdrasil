...
On appellera arbre binaire complet tout arbre qui est localement complet 
et dont toutes les feuilles ont la même profondeur.
Un arbre est localement complet si il n'a pas de noeuds avec un seul fils.

Une autre façon de le dire est un arbre complet a toutes les branches de même longueur.
