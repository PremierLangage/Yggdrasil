...
def buildquestion(questionp):
    ...
    try:
        ...
        if question.get('type') == 'Radio' :
            ...
            question['qitems']=bads
            return question
        if question.get('type') == 'Checkbox':
            goods,bads=[],[]

            for index,r in enumerate(question.get('qitems')):
                # more de rire r=question.get('qitems')[index]
            ...
            question['qitems'],question['index']=buildlistes(goods,bads)
            question['selector']='CheckboxGroup'
            return question
