...
funname=choice( ['Sed', 'trut', 'perspiciatis', 'unde', 'omnis', 'iste', 'natus', 'sit', 'voluptatem', 'accusantium', 'doloremque',
...
<a data-toggle="tab" href="#TESTINGCODE"> Le code utilisé pour le test </a></div></li>
