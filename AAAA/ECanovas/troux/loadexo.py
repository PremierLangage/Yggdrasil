...
def defFormMathinput(indice,dico):
    ...
    if indice==0:
        ...
        unInput='<p>'+input_prefix+'<span id="math-field'+str(indice)+'" style="font-size:14pt;padding: 0.2em;"></span></p> <input type="text" id="form_math'+str(indice)+'" > <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/mathquill/0.10.1/mathquill.min.css">'
    return unInput
