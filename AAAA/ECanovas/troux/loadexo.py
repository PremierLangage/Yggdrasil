...
def defFormMathinput(indice,dico):
    ...
    if indice==0:
        ...
        unInput='<span id="math-field1" style="font-size:14pt;padding: 0.2em;"></span> <input type="text" id="form_math2" hidden=true> <link rel="stylesheet" type="text/css" href="https://cdnjs.cloudflare.com/ajax/libs/mathquill/0.10.1/mathquill.min.css">'
    return unInput
