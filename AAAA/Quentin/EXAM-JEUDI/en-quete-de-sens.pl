...
** Soient $!E!$ et $!F!$ deux ensembles disjoints et soit $!f:E \to F!$ une application. Soient $!A\subset E!$ et $!B \subset F!$. Identifier l'assertion qui n'a pas de sens mathématiquement parlant. 
- $!f(A) \subset E!$
+ $!\forall y \in B, \quad f^{\\{-1\\}}(y) \in A!$
- $! A \subset f^{\\{-1\\}}(B) !$
- $! f^{\\{-1\\}}(B) = \emptyset !$

** Soient $!E!$, $!F!$ et $!G!$ trois ensembles deux à deux disjoints et soient $!f:E \to F!$ et $!g:F\to G!$ deux applications. Soient $!A\subset E!$, $!B \subset F!$ et $!C\subset G!$. Identifier l'assertion qui n'a pas de sens mathématiquement parlant. 
-$!(g\circ f)(A)=G!$
- $!g(B)=\emptyset!$
+ $!(g\circ f)^{\\{-1\\}}(C)=B!$
- $! f^{\\{-1\\}}(B) \subset A !$
