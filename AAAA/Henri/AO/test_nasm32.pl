...
process = subprocess.run(['nasm', '-f', 'elf32', 'hello_world.asm', '-o', 'hello.o'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
...
process = subprocess.run(['ld', '-m', 'elf_i386', 'hello.o', '-o', 'hello_w'], stdout=subprocess.PIPE, stderr=subprocess.PIPE)
stdout = process.stdout
ce = process.returncode
