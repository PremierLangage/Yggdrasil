...
$!\forall N\in\N,\quad (1-q)S_N\underset{(1)}{=}\sum_{n=0}^N(1-q)q^n\underset{(2)}{=}\sum_{n=0}^N(q^n-q^{n+1})\underset{(3)}{=}\sum_{n=0}^N q^n-\sum_{n=0}^N q^{n+1}\underset{(4)}{=}\sum_{n=0}^N q^n-\sum_{n=1}^{N+1} q^{n}\underset{(5)}{=} 1-q^{N+1}.!$
