...
import build
tab = build.builddata()
called_numbers,boards,data = build.called_numbers,boards,data
...
testcases, donnees = build.buildQ1(lexemple,called_numbers,boards,data)
changeText = False
==
...
testcases, donnees = build.buildQ2(lexemple,called_numbers,boards,data)
==
